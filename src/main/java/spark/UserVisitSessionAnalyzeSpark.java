...
//        stringRowJavaPairRDD.checkpoint();
    ...
    private static void getTop10Session(JavaSparkContext jsc, final long task_id, List<Tuple2<CategorySortKey, String>> top10CategoryList, final JavaPairRDD<String, Row> sessionid2detailRDD) {
        ...
        join.foreachPartition(new VoidFunction<Iterator<Tuple2<String, Tuple2<String, Row>>>>() {
            public void call(Iterator<Tuple2<String, Tuple2<String, Row>>> iterator) throws Exception {
                ...
                sessionDetailDAO.insertBatch(list);
...
/*        JavaPairRDD<Long, Long> resultRDD = map.reduceByKey(new Function2<Long, Long, Long>() {
        ...
        JavaPairRDD<String, Long> tempRDD = reslt.reduceByKey(new Function2<Long, Long, Long>() {
            public Long call(Long v1, Long v2) throws Exception {
                return v1 + v2;
            }
        });
        JavaPairRDD<Long, Long> temp2RDD = tempRDD.mapToPair(new PairFunction<Tuple2<String, Long>, Long, Long>() {

            public Tuple2<Long, Long> call(Tuple2<String, Long> tuple) throws Exception {
                String s = tuple._1.split("_")[1];
                return new Tuple2<Long, Long>(Long.valueOf(s), tuple._2);
            }
        });
        JavaPairRDD<Long, Long> resultRDD = temp2RDD.reduceByKey(new Function2<Long, Long, Long>() {
            public Long call(Long v1, Long v2) throws Exception {
                return v1 + v2;
            }
        });
